...
const CATALOG = [
  {
    ...
    name: "Beet gießen",
    phrase: "Beet gießen",
    desc: "Beet umschalten · Wasserhahn 2 · 20 Min · nur Ventil",
    color: 4282601983,
    webhookUrl: q([["action", "garten"], ["cmd", "toggle"], ["zoneId", "wh2-wintergarten"], ["minutes", "20"], ["format", "plain"], ["secret", SECRET]]),
  },
  {
    category: "bewaesserung",
    file: "salat-giessen",
    name: "Salat gießen",
    phrase: "Salat gießen",
    desc: "Salat umschalten · Wasserhahn 1 links · 20 Min · nur Ventil",
    color: 4292093695,
    webhookUrl: q([["action", "garten"], ["cmd", "toggle"], ["zoneId", "wh1-salat"], ["minutes", "20"], ["format", "plain"], ["secret", SECRET]]),
  },
  {
    category: "bewaesserung",
    ...
    desc: "Tomaten umschalten · Wasserhahn 1 rechts · mit Pumpe · 20 Min",
    color: 4251333119,
    webhookUrl: q([["action", "garten"], ["cmd", "toggle"], ["zoneId", "wh1-rechts"], ["minutes", "20"], ["format", "plain"], ["secret", SECRET]]),
  },
  {
    category: "bewaesserung",
